<%-- 
    Document   : nhasanxuatform
    Created on : Nov 20, 2018, 12:33:52 PM
    Author     : MINH TO
--%>
                            ...
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <form:form action="capnhat.html" modelAttribute="nhasanxuat" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <form:hidden path="mansx"/>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon">Ten Nha San Xuat:</span>
                                                         <form:input path="tennsx" class="form-control"/>
                                                    </div>
                                                    <c:if test="${sanpham.ten==null}">
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon">Hinh Anh:</span>
                                                         <input type="file" class="form-control pro-edt-select form-control-primary" name="hinhanhs"  value="<c:url value="/images/products/${tenhinhanh}"/>"  />
                                                    </div>
                                                    </c:if>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="pro-edt-img">
                                                                 <img src="<c:url value="/images/nhasanxuats/${tenhinhanh}"/>" alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <div class="row">
